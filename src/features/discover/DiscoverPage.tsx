    ...
    <section className="page" aria-labelledby="discover-title">
      <header className="gallery-hero">
        ...
        <div className="gallery-copy">
          ...
          <p>Browse the curated gallery in your browser. Download a .codextheme file, then open or import it here.</p>
          <div className="gallery-actions">
            ...
            <button className="secondary-button" type="button" onClick={() => void importTheme()}>
              <FileInput size={15} /> Import .codextheme
            </button>
          </div>
        </div>
      </header>
      <ol className="import-steps" aria-label="Theme installation steps">
        ...
        <li><span>2</span><div><strong>Download</strong><p>Save the .codextheme file from the theme page.</p></div></li>
        <li><span>3</span><div><strong>Import</strong><p>Open the file, then apply it from My Themes.</p></div></li>
      </ol>
    </section>
  );
}
